defmodule PlotWeb.Router do
  ...
  scope "/", PlotWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{PlotWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", PlotWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{PlotWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", PlotWeb do
    ...
    live_session :current_user,
      on_mount: [{PlotWeb.UserAuth, :mount_current_user}] do
